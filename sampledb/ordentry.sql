...
(
   CUSTNO         CHAR(8)         NOT NULL PRIMARY KEY,
...
(
   PRODNO            CHAR(8)         NOT NULL PRIMARY KEY,
...
(
   ORDNO      CHAR(8)       NOT NULL PRIMARY KEY,
...
VALUES
  ('E9884325','Thomas','Johnson','(303) 556-9987 ','TJohnson@bigco.com',NULL,0.050),
...
VALUES
  ('O1116324','2015-01-23','C0954327','E8544399','Sheri Gordon','336 Hill St.','Littleton','CO','80129-5543'),
...
VALUES
  ('P0036566','17 inch Color Monitor','ColorMeg, Inc.',12,169.00,'2015-02-20'),
